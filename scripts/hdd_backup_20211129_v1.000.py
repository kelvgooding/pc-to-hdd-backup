...
dateformat1 = datetime.datetime.today().strftime("%d/%m/%Y")

# Source

pc_documents = r"C:\Users\Kelv\Dropbox"
...
try:
    ...
    try:
        ...
        if os.path.isdir(hdd_documents):
            ...
            print("Copying {} to {}".format(pc_documents, hdd_documents))
            shutil.copytree(pc_documents, hdd_documents)
            print("Complete!")
        else:
            print("\nCopying {} to {}".format(pc_documents, hdd_documents))
            shutil.copytree(pc_documents, hdd_documents)
            print("Complete!")
    ...
    try:
        ...
        if os.path.isdir(hdd_pictures):
            ...
            print("Copying {} to {}".format(pc_pictures, hdd_pictures))
            shutil.copytree(pc_pictures, hdd_pictures)
            print("Complete!")
        else:
            print("\nCopying {} to {}".format(pc_pictures, hdd_pictures))
            shutil.copytree(pc_pictures, hdd_pictures)
            print("Complete!")
    ...
    try:
        ...
        if os.path.isdir(hdd_music):
            ...
            print("Copying {} to {}".format(pc_music, hdd_music))
            shutil.copytree(pc_music, hdd_music)
            print("Complete!")
        else:
            print("\nCopying {} to {}".format(pc_music, hdd_music))
            shutil.copytree(pc_music, hdd_music)
            print("Complete!")
    ...
    try:
        ...
        if os.path.isdir(hdd_videos):
            ...
            print("Copying {} to {}".format(pc_videos, hdd_videos))
            shutil.copytree(pc_videos, hdd_videos)
            print("Complete!")
        else:
            print("\nCopying {} to {}".format(pc_videos, hdd_videos))
            shutil.copytree(pc_videos, hdd_videos)
            print("Complete!")
    ...
    try:
        ...
        if os.path.isdir(hdd_software):
            ...
            print("Copying {} to {}".format(pc_software, hdd_software))
            shutil.copytree(pc_software, hdd_software)
            print("Complete!")
        else:
            print("\nCopying {} to {}".format(pc_software, hdd_software))
            shutil.copytree(pc_software, hdd_software)
            print("Complete!")
